...
The safety properties established for single-agent GLP in Section~\ref{sec:glp} extend to maGLP:
...
[[This is informal text, not a proposition, say informally before what is needed, defined what is needed, and then state the proposition without verbiage]]
