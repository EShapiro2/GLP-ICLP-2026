...
\begin{lemma}[maGLP Persistence]
\label{lem:maglp-persistence}
maGLP is persistent: all transactions, once enabled, remain enabled until taken. Reduce persistence follows from GLP persistence (Lemma~\ref{lem:persistence}); Communicate and Cold-call transactions remain enabled since Reduce transitions do not remove reader assignments or network messages.
\end{lemma}
