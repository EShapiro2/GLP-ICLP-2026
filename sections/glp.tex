...
Additional programming examples---including stream distribution, association list lookup, channel abstractions, stream tagging, cooperative production, and metainterpreters---appear in \appref{appendix:additional-techniques}{\arxivref}.
