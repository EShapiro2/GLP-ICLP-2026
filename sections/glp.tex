...
\end{definition}
The outcome employs pair completion (Definition~\ref{def:writers-assignment}) since $\sigma_n$ accumulates only readers counterparts, leaving the writers of $G_0$ unbound. Let $/?$ be an operator that replaces every reader by its paired writer.
