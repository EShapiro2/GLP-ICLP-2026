...
This section establishes that maGLP is grassroots, following the framework of~\cite{shapiro2023grassrootsBA,shapiro2025atomic}. The full definitions of protocols, projections, transactions-based protocols, and interactive transactions appear in Appendix~\ref{appendix:grassroots-defs}; here we state the key definition and results.
