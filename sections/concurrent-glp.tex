...
The $LP(P)$ transition system also supports denotational semantics, including clause semantics~\cite{gaifman1989fully}, atom semantics, and ground atom semantics~\cite{lloyd1987foundations}; see Appendix~\ref{appendix:denotational}.
