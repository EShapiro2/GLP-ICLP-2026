%==============================================================================
\section{maGLP is Grassroots}\label{sec:grassroots}
%==============================================================================
...
\emph{maGLP is transactions-based}: By Definition~\ref{definition:maGLP}, maGLP is defined via a set of transactions (Reduce, Communicate, Network) over a local-states function (asynchronous resolvents) with a common initial state. Hence maGLP is a transactions-based protocol (Definition~\ref{definition:tb-protocol}).
