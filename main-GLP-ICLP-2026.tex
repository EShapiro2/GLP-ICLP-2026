...
% EPTCS extracts \title verbatim into arXiv metadata: keep it literal (no \\, no conditionals).
% For the arXiv (\appendixtrue) build, append " (Full Version)" by hand.
