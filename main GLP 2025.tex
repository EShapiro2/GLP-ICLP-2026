...
\begin{keywords}
concurrent logic programming, grassroots platforms, secure communication, multiagent systems, cryptographic protocols
\end{keywords}
...
\input{glp_section_logic_programs}
\input{glp_section_glp}
\input{glp_section_examples}
\input{glp_section_multiagent}
\input{glp_section_social_graph}
\input{glp_section_security}
\input{glp_section_implementation}
