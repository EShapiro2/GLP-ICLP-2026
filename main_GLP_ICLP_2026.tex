...
% TEMPORARY natbib-compatibility shim --- to be removed once all \citep and
% \citeN sites have been rewritten to EPTCS-style \cite.  Until then this
% keeps the paper compiling between per-file commits.
