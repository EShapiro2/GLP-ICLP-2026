...
This directory, `GLP-Definitive-Spec`, is the map's **GLP-ICLP** project, and pushes to a remote named `GLP-ICLP-2026` — three names for one thing.  Everything else about the paper is in `main-GLP-ICLP-2026.tex`: title, venue, class, bibliography, section order, the `\ifappendix` build policy, and the LaTeX commands it defines.
