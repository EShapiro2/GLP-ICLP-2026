...
\begin{abstract}
A digital platform is \emph{grassroots} if it can have multiple instances that operate independently of each other and of any global resource other than the network, yet may coalesce into ever larger instances, possibly into a single global instance.
